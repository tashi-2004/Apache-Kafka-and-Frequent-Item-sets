...
def store_frequent_itemsets_in_mongodb(db, frequent_itemsets):
    collection = db["frequent_itemsets"]  # Collection name
    for itemset in frequent_itemsets:
        collection.insert_one({"frequent_itemset": list(itemset)})
...
def process_message(message, window_size, min_support, db):
    ...
    store_frequent_itemsets_in_mongodb(db, frequent_itemsets)
...
for message in consumer:
    process_message(message, window_size, min_support, db)
