...
#candidates
def prune_candidates(candidates, prev_freq_itemsets, k, hash_counts, hash_buckets, threshold):
...
def generate_frequent_itemsets(data, min_support, hash_counts, hash_buckets, threshold):
    ...
    while itemsets:
        ...
        pruned_candidates = prune_candidates(candidates, set(freq_itemsets), k+1, hash_counts, hash_buckets, threshold)
